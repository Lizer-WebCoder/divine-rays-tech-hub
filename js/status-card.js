...
(function () {
  ...
  if (!document.getElementById('dr-status-card-css')) {
    ...
    st.textContent = [
      ...
      '#portal-agent .sidebar-avatar-chip{display:flex;justify-content:center;margin:.3rem 0 .3rem!important}',
      '#portal-agent .sidebar-avatar-chip .avatar-img,#portal-agent .sidebar-avatar-chip .avatar-fallback,#portal-agent .sidebar-avatar-chip img{width:52px!important;height:52px!important;border-radius:50%!important;object-fit:cover!important;display:block;border:2px solid rgba(124,106,240,.55);box-shadow:0 0 0 3px rgba(124,106,240,.15),0 4px 14px rgba(0,0,0,.35)}',
