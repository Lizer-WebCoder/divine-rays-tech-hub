/**
 * Divine Rays — login light mode + theme toggle on login screen
...
(function () {
  ...
  var CSS = [
    ...
    '  box-shadow:0 12px 40px rgba(30,30,60,.1)!important;',
    ...
    'html[data-theme="light"] #login-screen input[type="text"],',
    'html[data-theme="light"] #login-screen input[type="email"],',
    'html[data-theme="light"] #login-screen input[type="password"]{',
    '  background:#eef0f7!important;',
    '  color:#1a1a2e!important;',
    '  border:1px solid #c8cad8!important;',
    '}',
    'html[data-theme="light"] .login-form input::placeholder,',
    'html[data-theme="light"] #login-screen input::placeholder{',
    ...
    '  box-shadow:0 0 0 3px rgba(109,94,245,.2)!important;',
    '}',
    ...
    '}',
    '#dr-login-theme{',
    '  position:fixed;top:1rem;right:1rem;z-index:10050;',
  ...
  function ensureToggle() {
    ...
    var visible = login && !login.hidden && !login.classList.contains('is-hidden') &&
  ...
  injectCss();
  try {
    var t0 = localStorage.getItem('dr_theme') || 'dark';
  ...
  try {
    new MutationObserver(tick).observe(document.body, { childList: true, subtree: true, attributes: true, attributeFilter: ['hidden', 'class'] });
  } catch (e) {}

  window.DRLoginTheme = { refresh: tick, setTheme: setTheme };
})();
